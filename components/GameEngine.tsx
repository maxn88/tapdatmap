  ...
  return (
    <div className="flex flex-col h-screen bg-gray-950">
      ...
      <div className="flex flex-col md:flex-row flex-1 overflow-hidden">
        ...
        <div className="h-[38vh] md:h-auto md:flex-none md:w-72 flex flex-col bg-gray-900 border-t md:border-t-0 md:border-l border-gray-800 overflow-y-auto shrink-0">
          {phase === "guessing" && (
            <CluePanel
              round={currentRound}
